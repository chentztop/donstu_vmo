...
def main():
  ...
  if is_rrg(rules, terms, non_terms):
      print("Класс 3: Праволинейная грамматика")
      return
  elif is_lrg(rules, terms, non_terms):
      print("Класс 3: Леволинейная грамматика")
      return
  elif is_cfg(rules, terms, non_terms):
      print("Класс 2: Контекстно-свободная грамматика")
      return
  elif is_ng(rules, terms, non_terms, start_symbol):
      if is_csg(rules, terms, non_terms, start_symbol):
